...
class Shortcodes{
	...
	function add_buttons( $plugin_array ) {
	    $plugin_array['couponxxl'] = get_template_directory_uri() . '/js/shortcodes.js';
	    return $plugin_array;
	}

	function register_buttons( $buttons ) {
	    array_push( $buttons, 'couponxxlgrid', 'couponxxlelements' ); 
	    return $buttons;
	}
	...
	function shortcode_options(){
		...
		if( $shortcode == 'row' ){
			...
			$shortcode = 'couponxxl_'.$shortcode.'_params';
	...
	function render_options( $fields ){
				...
				switch ( $field['type'] ){
					...
					case 'attach_image' :
						$fields_html .= '<div class="shortcode-image-holder"></div><div class="clearfix"></div>
										<a href="javascript:;" class="shortcode-add-image button">'.esc_html__( 'Add Image', 'couponxxl' ).'</a>
					...
					case 'attach_images' :
						$fields_html .= '<div class="shortcode-images-holder"></div><div class="clearfix"></div>
										<a href="javascript:;" class="shortcode-add-images button">'.esc_html__( 'Add Images', 'couponxxl' ).'</a>
		...
		echo  $fields_html.'<a href="javascript:;" class="shortcode-save-options button">'.esc_html__( 'Insert', 'couponxxl' ).'</a>';
		die();
